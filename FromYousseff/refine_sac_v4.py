...
def main():
    # Refinement v4: Aggressive Jackpot focus
    ...
    logger = setup_dirs("sac_refine_v4")
    
    # Base is the refined_v3 model (the v3.5 result)
    base_path = os.path.join(MODELS_DIR, "qube_sac_refined_v3.zip")
    ...
    # Callbacks
    cb_list = callbacks("sac_refine_v4", args.n_envs)
    ...
    final_save_path = os.path.join(MODELS_DIR, "qube_sac_refined_v4")
